...
title: "Pokémon is Technical"
---

It's been a few weeks since my first [post about Pokémon Red](https://krgamestudios.com/posts/2026-01-02-pokemon-is-special), and in that time I've travelled from the end of Nugget Bridge to Celadon City, picking up two more badges in the process. Let's go through the notes I wrote in that time, and expand on the interesting elements that caught my eye.
...
<div style="text-align: center">
	<img src="/assets/2026-01-20/bill1.png" style="max-width: 200px">
	<img src="/assets/2026-01-20/bill2.png" style="max-width: 200px">
	<img src="/assets/2026-01-20/bill3.png" style="max-width: 200px">
	<p><em>If Bill can screw up an experiment, I'm allowed to screw up a screenshot.</em></p>
</div>
...
<div style="text-align: center">
	<img src="/assets/2026-01-20/ss-anne.png" style="max-width: 200px">
	<p><em>It looked bigger in the catalogue.</em></p>
</div>

Exploring the ship was a fun experience, enhanced by the fact that once you've finished what is essentially a dungeon, it becomes totally inaccessible from then on[^1]. There's several TMs and other items here that become totally unobtainable once you've obtained HM01 Cut. There's also some interesting characters, like "Le Waiter" (which may have inspired [Restaurant Le Nah](https://bulbapedia.bulbagarden.net/wiki/Restaurant_Le_Nah) and [Restaurant Le Yeah](https://bulbapedia.bulbagarden.net/wiki/Restaurant_Le_Yeah) in Lumiose City), and the Global Police Agent, which almost certainly inspired the character of [Looker](https://bulbapedia.bulbagarden.net/wiki/Looker).
...
<div style="text-align: center">
	<img src="/assets/2026-01-20/crew2.png" style="max-width: 200px">
	<img src="/assets/2026-01-20/crew1.png" style="max-width: 200px">
	<p><em>Woke? No, these are my sleepy eyes.</em></p>
</div>

I won't go down that rabbit-hole - I'll leave that to people who enjoy drama. I'm playing this game to learn more about the foundations of the series, and to make silly movie references[^2].

<div style="text-align: center">
	<img src="/assets/2026-01-20/bow.png" style="max-width: 200px">
	<p><em>I'm king of the world!</em></p>
</div>
...
<div style="text-align: center">
	<img src="/assets/2026-01-20/dux-the-farfetchd.png" style="max-width: 200px">
	<p><em>Just 23 more years, buddy.</em></p>
</div>
...
<div style="text-align: center">
	<img src="/assets/2026-01-20/helix-fossil.png" style="max-width: 200px">
	<p><em>PRAISE HELIX</em></p>
</div>

*When I'm not peeking into Erika's Gym, I can usually be found on [Bluesky](https://bsky.app/profile/krgamestudios.bsky.social) or [Discord](https://discord.gg/5KwPFdTBZp). If you'd like to show your support, I also have a [Patreon](https://www.patreon.com/c/krgamestudios), and I'd love a Coffee via [Ko-fi](https://ko-fi.com/krgamestudios).*

[^1]: A kid told me the S.S. Anne would return when the game clock reached 200 hours, and you could catch Mew on board. Fuck you Ben.
[^2]: Yes this was jammed in badly just to use this picture.
